...
#define MQTT_TEMPERATURE_TOPIC      SIMPLE_BATCHING_MQTT_TEMPERATURE_TOPIC
#define MQTT_HUMIDITY_TOPIC         SIMPLE_BATCHING_MQTT_HUMIDITY_TOPIC
#define MQTT_INFLUX_TOPIC           SIMPLE_BATCHING_MQTT_INFLUX_TOPIC
#define CLIENT_ID                   SIMPLE_BATCHING_CLIENT_ID
