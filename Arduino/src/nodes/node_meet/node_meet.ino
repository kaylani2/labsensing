...
#define MQTT_TEMPERATURE_TOPIC      MEET_MQTT_TEMPERATURE_TOPIC
#define MQTT_HUMIDITY_TOPIC         MEET_MQTT_HUMIDITY_TOPIC
#define MQTT_MOVEMENT_TOPIC         MEET_MQTT_MOVEMENT_TOPIC
#define MQTT_INFLUX_TOPIC           MEET_MQTT_INFLUX_TOPIC
#define CLIENT_ID                   MEET_CLIENT_ID
